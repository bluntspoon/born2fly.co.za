...
<div style="max-width: 900px; margin: 2rem auto; text-align: center;">
  <img src="{{ '/assets/images/team.jpeg' | relative_url }}" alt="Born2Fly Coaching Team" style="width: 100%; height: auto; border-radius: 1rem; box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);">
